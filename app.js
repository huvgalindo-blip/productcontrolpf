...
function cambiarVista(vista) {
    ...
    switch (vista) {
        ...
        case 'dashboard':
            ...
            break;
        case 'comparativa':
            if (typeof renderizarComparativa === 'function') {
                renderizarComparativa();
            } else {
                mostrarNotificacion('Vista en desarrollo', 'warning');
            }
            break;
        case 'amasado':
            if (typeof renderizarOrdenAmasado === 'function') {
...
function inicializarApp() {
    ...
    // 4. Renderizar la vista inicial (producción)
